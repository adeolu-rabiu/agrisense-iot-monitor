...
class SiloSimulator:
    def __init__(self, silo_idx, mqtt_host=MQTT_HOST, mqtt_port=MQTT_PORT):
        ...
        # Pre-register all metric labels & set baseline values.
        ...
        sensor_dropout.labels(silo_id=self.silo_id).inc(0)  # ensures the series exists
    ...
    def update_metrics(self):
        ...
        # Simulate dropout; when dropout happens we DO NOT publish telemetry this tick,
        # but we still increment the counter so the metric exists & increases.
